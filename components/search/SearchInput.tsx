    ...
    <div className={`relative ${className}`} ref={suggestionsRef}>
      <form onSubmit={handleSubmit} className="relative">
        <input
          ...
          className="w-full px-5 py-3 pl-12 pr-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white text-sm font-light tracking-wide placeholder:text-neutral-300 focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-500/50 transition-all"
        />
